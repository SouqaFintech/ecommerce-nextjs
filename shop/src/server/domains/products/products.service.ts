...
const popularProducts: Product[] = popularProductsJson as unknown as Product[];
const bestSellingProducts: Product[] = bestSellingProductsJson as unknown as Product[];
...
const fuse = new Fuse<Product>(products, options);
